...
def run_tmux_commands(session_name, commands):
    ...
    try:
        ...
        for i, cmd in enumerate(commands):
            ...
            full_command = f"cd ~/mavros_ws && source install/setup.bash && {cmd}"
...
if __name__ == "__main__":
    ...
    commands = [
        ...
        "sleep 10.0 && cd bags && cd test && rm -rf rosbag* && ros2 bag record /repub_des_pos /repub_mes_pos /repub_mes_vel /repub_des_att", # Pane 6
